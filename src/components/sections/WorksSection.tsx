import "./styles.css";
import { CardWorksCarousel } from "../layout/CardWorksCarousel";
...
export const WorksSection = ({ dict }: CaseStudyChartProps) => {
  return (
    <section className="bg-black text-white py-12 flex flex-col gap-10 lg:flex-row lg:items-center bg-[url('/images/sections-slide-background.png')] bg-bottom lg:bg-left bg-no-repeat h-full lg:h-[670px] px-8 md:pl-24 md:pr-10 lg:w-full lg:gap-10">
      ...
      <div className="w-full lg:w-[45%]">
        ...
        <div className="flex flex-wrap justify-center lg:justify-end gap-9 items-stretch">
          {dict.textSliders.map((item, index) => (

...
export function AgilitySection({ dict }: AgilitySectionProps) {
  return (
    <section className="w-full bg-[url('https://website-actai.s3.sa-east-1.amazonaws.com/imagens/plataform/bg-section-agility.png')] bg-no-repeat bg-cover lg:bg-contain bg-left py-16 md:py-24">
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-4 rounded-2xl border border-[#EDEDED] bg-[#FFFFFF40] px-5 py-4 shadow-[0_8px_30px_rgba(33,133,208,0.08)]">
                    <span className="flex h-[50px] w-[50px] items-center justify-center rounded-xl bg-sky-100 text-sky-600">
                      <Icon
                        size={24}
                        aria-hidden="true"
                        color="#103C68"

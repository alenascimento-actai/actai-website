  ...
  return (
    <section className="w-full py-16 md:py-24">
      <div className="container mx-auto px-6">
        {/* CARD */}
        <div className="rounded-[21px] bg-[#F4F5F8] h-[250px] lg:h-[508px] flex items-center justify-end">
          ...
          <div className="max-w-[342px] pr-14 lg:pr-0 lg:max-w-1/2 lg:w-full">
            <RevealOnView revealClasses="animate-fade-right animate-duration-[2000ms] animate-delay-200">
              <h2 className="text-2xl md:text-3xl lg:text-[48px] font-extrabold leading-tight text-[#131922]">
                {dict.title}
              </h2>

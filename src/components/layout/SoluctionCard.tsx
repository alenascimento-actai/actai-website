...
export function SolutionCard({ title, description, icon }: SolutionCardProps) {
  return (
    <div className="relative flex flex-col justify-between h-[435px] px-6 py-8 rounded-2xl shadow-xl overflow-hidden bg-[#2D183C] border border-white/10 lg:hover:scale-[1.01] lg:transition border-gradient">

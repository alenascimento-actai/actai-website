...
export function SolutionCard({ title, description, icon }: SolutionCardProps) {
  return (
    <div className="relative flex flex-col justify-between h-[435px] px-6 py-8 rounded-2xl shadow-xl overflow-hidden bg-gradient-to-br from-[#3B1554]/60 to-[#1B102B]/70 backdrop-blur-sm bg-white/30 border border-white/10 hover:scale-[1.01] transition border-gradient">
